...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ \"./src/scripts/utils.js\");\n\nvar newsEl = document.querySelector('.news');\n\nfunction getNews$() {\n  Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"getNews\"])().then(function (res) {\n    var markup = res.articles.reduce(function (news$, news) {\n      return news$ += \"<p><h2>\".concat(news.title, \"</h2><br>\").concat(news.content, \"</p>\");\n    }, '');\n    newsEl.innerHTML = markup;\n  }).catch(function (err) {\n    return newsEl.innerHTML = err;\n  });\n}\n\ngetNews$();\n\n//# sourceURL=webpack:///./src/scripts/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getNews\", function() { return getNews; });\nvar getNews = function getNews() {\n  var api = \"https://newsapi.org/v2/everything?q='teknologi'&language=id&sortBy=publishedAt&apiKey=666b8a7c81104db8a63865be5edd9cac\";\n  var body = fetch(api).then(function (res) {\n    return res.json();\n  });\n  return body;\n};\n\n//# sourceURL=webpack:///./src/scripts/utils.js?");
